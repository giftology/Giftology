...
return false; }  
 ...
 <div style="margin-top:100px">
 	<center>
           <?php 
           echo $this->Form->create('gifts', array('action' => 'email_voucher_otp'));
            
             echo $this->Form->hidden("id" ,array('label' => false,'div' => false,'value'=>$gift['Gift']['id']))?>
             <div class="input email">
             	<br><br>
                
                <div class="input email" ><label for="email">Email OTP   </label><?php echo $this->Form->input("email" ,array('id' => 'email', 'label' => false,'div' => false,'class'=>"umstyle5", 'placeholder' => "Valid Email Address",'value'=>$email))?></div>
            ...
            <?php echo $this->Form->hidden("gift_id" ,array('label' => false,'div' => false,'value'=>$facebook_user['$gift_id'] ))?>
             <br><br>
