  ...
  <div style="width:630px; margin:0 auto; padding:0 10px 10px 10px; background:#E14C41 url(../img/red_main-bg.jpg) no-repeat 0 0; min-height:430px; position:relative; overflow:hidden;">
    <div style="width:100%; float:left;">
      <table style="width:100%; margin:0; padding:0;" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="center"><h2 style="font:Georgia, 'Times New Roman', Times, serif; margin:0; padding:10px 0 10px 0;"><font style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:30px; color:#FFF; font-style:italic; font-weight:300;">Hi <?=$facebook_user['first_name']; ?></font></h2></td>
        </tr>
        <tr>
