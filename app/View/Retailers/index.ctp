...
<script type="text/javascript">
 ...
 <div class="input email" ><?php echo $this->Form->hidden("gift_id" ,array('label' => false,'div' => false,'value'=>$session_token ))?></div>
                  ...
                  <div class="input email" style="margin-top:10px">
                          ...
                          <div class="captcha " >
                            <div class="input email" style="margin-top:10px; width:270px; float:right; border:1px solid #CCCCCC; border-radius:5px;">
                             <div  class="captha1">
                              <?php echo  $captcha ?>
                            </div>
                            
                              <?php echo $this->Form->input('captcha', array('label' => '','placeholder'=>'Solve it!','style'=>'text-align:center; width:80px; margin:17px 77px 8px 77px;'));?></div>
            ...
            <?php echo $this->Form->Submit(__('Send'), array('id'=>'form_shipping','style'=>'margin-left:178px'));?>  
