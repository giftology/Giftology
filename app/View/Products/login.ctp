<?php $this->layout = 'gift_login'; ?>
    ...
    <?php echo $this->Facebook->login(array('img' => 'fb-connect-large.png','redirect' => array('controller'=>'products', 'action'=>'login'."?token=".$encrypted_id."&token_first=".$session_token))); ?>
