...
<div class="mainpage">
	<div class="header">
		...
		<ul class="nav float-l">
			...
			<li><a href=<?= $this->Html->url(array('controller'=>'reminders',  'action'=>'view_friends', 'all')); ?> class="friends <?= isset($friends_active) ? $friends_active:''; ?>"><span>Valentine's Day</span></a></li>
