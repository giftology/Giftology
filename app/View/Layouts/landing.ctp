         ...
         <section class="content-wrap">
            ...
            <div class="how-it-work">
               <div style="width:960px; margin:auto;">
                        ...
                        <?php endforeach; ?>
                       <a href=<?= $this->Html->url(array('controller'=>'users', 'action'=>'product')); ?>><span class="product_label" style=" color: #F5F7F2;background-color: crimson;float:right;margin-top:0px;margin-right:38px;font-size: 13px;border-radius: 2px 2px 2px 2px;display: inline-block;text-shadow: none;font-weight: bold;padding: 3px 5px 3px 5px;">See More</span></a>
               </div>
             </div>
