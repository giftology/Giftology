<div class="ageSegments view">
<h2><?php  echo __('Age Segment'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($ageSegment['AgeSegment']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($ageSegment['AgeSegment']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Min'); ?></dt>
		<dd>
			<?php echo h($ageSegment['AgeSegment']['min']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Max'); ?></dt>
		<dd>
			<?php echo h($ageSegment['AgeSegment']['max']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Age Segment'), array('action' => 'edit', $ageSegment['AgeSegment']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Age Segment'), array('action' => 'delete', $ageSegment['AgeSegment']['id']), null, __('Are you sure you want to delete # %s?', $ageSegment['AgeSegment']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($ageSegment['Product'])): ?>
	...
	<?php
		$i = 0;
		foreach ($ageSegment['Product'] as $product): ?>
		<tr>
