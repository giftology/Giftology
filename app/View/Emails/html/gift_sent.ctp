...
<body>
<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" style="margin:0;padding:0;background-color:#f7f5ae;min-height:100%!important;width:100%!important">
<tr>
...
<a href="<?= $linkback; ?> style="border:0"><img align="none" width="200" height="64" src="<?= $wide_image_link; ?>"></a></div>
