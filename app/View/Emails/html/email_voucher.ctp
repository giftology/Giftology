        ...
        <tr>
          ...
          <div style="background:#F0F0F0; text-align:center; overflow: hidden; padding:14px 0 18px 0; margin:15px 0 -25px 0;">
            ...
            <div style="width:260px;background-image:url(<?=IMAGE_ROOT?>red_voucher-frame.png);  height:205px; border:1 solid black; float:left;">
                <h3 style="margin:40px 0 0 -19px; padding:0; color:#333; font-family:'Arial Black', Gadget, sans-serif; font-size:32px; font-weight:600; text-align:center;"> <img src="<?=IMAGE_ROOT?>red_rupee'.png" height="30" width="30" style="margin-right:-8px;"> <?=$gift['Gift']['gift_amount']; ?></h3>
                <p style="margin-top:20px;"><img src="<?=IMAGE_ROOT?>red_shad-bg1.png" width="240"></p>

                <p style="margin:-10px 0 0 0; "><img src="<?= FULL_BASE_URL.'file://'.$gift['Product']['Vendor']['wide_image']; ?>" height="50" width="180" alt="giftology.com" title="giftology.com" align="center" ></p>
            </div>
          </td>
        ...
        <tr >
          ...
          <div style="background:#fff;  overflow:hidden; margin:0 auto; width:630px;">
              <div style=" width:270px; margin:0 10px; float:left; ">
               ...
               <img src="<?=IMAGE_ROOT?>red_new.png" height=525>
               </div>
               <div style=" width:270px; margin:0 25px; float:left; text-align:justify;  ">
                ...
                <p style="margin:0; padding:0; color:#333; line-height:22px;"><font style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:14px; font-weight:300; font-style:italic; color:#333;"> For any further queries, mail us :<b> support@thewatchshop.in</b></font></p>
                <p>&nbsp;</p>
              </div>
            </div>
            </td>
