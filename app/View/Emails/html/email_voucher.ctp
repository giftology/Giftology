...
<div style="width:650px; margin:0 auto;">
  <div style="width:630px; margin:0 auto; padding:0 10px 10px 10px; background:#E14C41 url(<?=IMAGE_ROOT?>/red_main-bg.jpg) no-repeat 0 0;  position:relative; overflow:hidden;">
    <div style="width:100%; float:left;">
      <table style="width:100%; margin:0; padding:0;" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center"><a href="http://www.giftology.com/" target="_blank"><img src="<?=IMAGE_ROOT?>logo.png" alt="" style="outline:none;"></a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="center">
          <div style="background:#F0F0F0; text-align:center; overflow: hidden; padding:14px 0 18px 0; margin:15px 0 -25px 0;">
              ...
              <table style="width:530px; margin:0; padding:20px 0; display:inline-block;">
                <tr>
                  <td>  
            <div style="width:260px;background-image:url(<?=IMAGE_ROOT?>red_voucher-frame.png);  height:205px; border:1 solid black; float:left;">
                <h3 style="margin:40px  0 -19px; padding:0; color:#333; font-family:'Arial Black', Gadget, sans-serif; font-size:32px; font-weight:600; text-align:center;"> <img src="<?=IMAGE_ROOT?>red_rupee'.png" height="30" width="30" style="margin-right:-8px;"> <?=$gift['Gift']['gift_amount']; ?></h3>
                <p style="margin-top:20px;"><img src="<?=IMAGE_ROOT?>red_shad-bg1.png" width="240"></p>
                ...
                <p style="margin:-10px 0 0 0; "><img src="<?= FULL_BASE_URL.'/'.$gift['Product']['Vendor']['wide_image']; ?>" height="50" width="180" alt="giftology.com" title="giftology.com" align="center" ></p>
                  ...
                  <td style="width:259px; margin:0px; float:left; background-image:url(<?=IMAGE_ROOT?>red_voucher-frame.png); height:205px;" >
                    <h3 style="margin:45px 0 -12px 12px;  padding:0; color:#333; font-size:20px; font-family:Georgia, 'Times New Roman', Times, serif; font-weight:300; text-align:center; line-height:180%;"><br><font size="+1" color="#9f2027" ><?=$gift['Gift']['code']; ?></font></h3>
        ...
        <tr>
            <td align="center" width="200px" bgcolor="#FOFOFO" >
            <img src="<?=IMAGE_ROOT?>red_shad-bg.png">
            </td>
        </tr>
        <tr >
        
          <td align="left">
          <div style="background:#fff;  overflow:hidden; margin:0 auto; width:630px;">
              <div style=" width:280px; margin:0 -5px 0 0; float:left; text-decoration:justify; ">
                <h2 style="margin:0 11px; padding:20px 0 20px 24px; "><font style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:18px; font-weight:300; font-style:italic;">How To Redeem </font></h2>
                
                    <div style="line-height:1.5 !important; text-decoration:justify !important;  ">  <?= strip_tags($gift['Product']['redeem_instr'],'<p><span><ol><li>'); ?></div>
                 
              </div>
                <div style=" width:20px;  margin:0px 28px 0px 0px; float:left; height:auto ;">
               <img src="<?=IMAGE_ROOT?>red_new.png" height="500">
               </div>
               <div style=" width:280px; margin:0 15px 0 0; float:left; text-align:justify ; ">
                <h2 style="margin:0 35px ; padding:20px 0 20px 0;"><font style="font-family:Georgia, 'Times New Roman', Times, serif; font-size:18px; font-weight:300; font-style:italic;">Terms & Conditions </font></h2>
