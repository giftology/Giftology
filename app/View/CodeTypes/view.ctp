...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Code Type'), array('action' => 'edit', $codeType['CodeType']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Code Type'), array('action' => 'delete', $codeType['CodeType']['id']), null, __('Are you sure you want to delete # %s?', $codeType['CodeType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Code Types'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Code Type Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($codeType['Product'] as $product): ?>
		<tr>
			...
			<td><?php echo $product['code_type_id']; ?></td>
