...
<?php echo $this->Facebook->html(); ?>
   ...
   <div id="foot_content" >
	<div class="content" style="margin:0 30px 0 30px ; ">
...
<p style="padding-left:5px;font:normal 14px/24px Georgia, 'Times New Roman', Times, serif;color:black;text-align:left;">1. When your friend signs up and sends A GIFT TO YOU.</p>
<p style="padding-left:5px;font:normal 14px/24px Georgia, 'Times New Roman', Times, serif;color:black;text-align:left;">2. You are among the top 10% GIFTERS of the  week.<p>
	<p style="padding-left:5px;font:normal 14px/24px Georgia, 'Times New Roman', Times, serif;color:black;text-align:left;">For more FREE HIT options stay Posted to our <a href="https://www.facebook.com/GiftologyIndiaa" style="color:#9f2027; text-decoration:underline;">facebook page</a>.  </p>
<h2 style="margin:0 ;padding:20px 0 10px 0;color: #333;display: block;text-align: left;font:20px/100% Georgia, 'Times New Roman', Times, serif;">HURRY UP! </h2>
  <a href="https://www.giftology.com/" style="text-decoration:none;"> <div style="height:58px; width:286px; background:#4162a7; overflow:hidden; border:1px solid #243559; border-radius:4px; color:#FFF; padding:0 0 0 10px; font:28px/185% bold Arial, Helvetica, sans-serif ;  box-shadow:0 0 5px #4162a7;">
           <span style="border-right:1px #f2f2f2 solid; margin:0 5px 0 10px;"><b> f </b></span> <span> Start Gifting Now!!</span>
           
          </div>
          </a>
	<p style="padding:10px 0 0 5px;font:italic 12px/22px Georgia, 'Times New Roman', Times, serif;color:black;text-align:left;"> *Pls gift only your authentic Facebook friends not just IDs</p>
	<p style="padding-left:5px;font:italic 12px/22px Georgia, 'Times New Roman', Times, serif;color:black;text-align:left;">** No Travelling expenses will be borne by the company </p><br>
    </div>
