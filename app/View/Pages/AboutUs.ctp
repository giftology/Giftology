 ...
 <div id="foot_content" >
	<div class="content">
		<center><h3>ABOUT US</h3></center>
          ...
          <p> Do away with your gifting woes, because Giftology is here to make your life a lot simpler!! We’re a social gifting platform. In simple words, we enable you to send gifts to your friends on Facebook! Now isn’t that awesome? </p><br>
                      ...
                      <IMG SRC="../img/SB.jpg" rel="#mies6">
                        <div class="simple_overlay" id="mies6">
                           <!-- large image -->
                                ...
                                <p><strong> Shailesh Bhushan</strong></p>
                        <p><strong> Finance Director</strong></p>
                           ...
                           <p>Previously,Shailesh has worked with Transact Network Ltd. as V.P Finance managingthe financial operations of its prepaid card business.  He has also worked with leading Indian business houses such as DLF and Reliance with scope of business in to construction, power, service, education, ITES and finance sector.</p>
