...
<center><h3>CAREERS</h3></center>
   ...
   <div id="foot_content_contact" >
      ...
      <div class="leftd">
      <p id="contacttexth2"> <img src="<?php echo FULL_BASE_URL;?>/img/findusat.png"><span>find us </span></p>
...
Gurgaon 122002</p>
<p id="contacttext1">-----------------------------------------</p>
<p id="contacttexth2" style="padding-top:5px"><img src="<?php echo FULL_BASE_URL;?>/img/callaticon.png"><span>Phone</span></p>
<p id="contacttexth1">To reach us on phone you can call:</p>
<p id="contacttext" >+91-9717881110</p>
<p id="contacttext1">-----------------------------------------</p>
<p id="contacttexth2" style="padding-top:5px"><img src="<?php echo FULL_BASE_URL;?>/img/emailicon.png"><span>Email:</span></p>
