<style>
    ...
    font-size:10px;
     ...
     th {background: #FCF7F7 repeat-x 0 -110px; line-height: 100%;font: normal 13px Arial, Helvetica, sans-serif; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; -webkit-box-shadow: 0 1px 6px rgba(0,0,0, .4); -moz-box-shadow: 0 1px 3px rgba(0,0,0, .4); padding:2px 2px;}
    tr,td {background: #FCF7F7 repeat-x 0 -110px; line-height: 100%;font: normal 12px Arial, Helvetica, sans-serif; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; -webkit-box-shadow: 0 1px 3px rgba(0,0,0, .4); -moz-box-shadow: 0 1px 3px rgba(0,0,0, .4); padding:0 2px 0 2px;}

         #cssmenu ul {margin: 0; padding: 7px 6px 0; background: #FCF7F7 url(../img/overlay.png) repeat-x 0 -110px; line-height: 100%; border-radius: 1em; font: normal 18px Arial, Helvetica, sans-serif; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; -webkit-box-shadow: 0 1px 3px rgba(0,0,0, .4); -moz-box-shadow: 0 1px 3px rgba(0,0,0, .4);}
         ...
         #cssmenu a:hover {background: #FCF7F7; color: #000000;}
         #cssmenu .active a, 
         #cssmenu li:hover > a {background: #FCF7F7 url(../img/overlay.png) repeat-x 0 -40px; color: #000000; border-top: solid 1px #f8f8f8; -webkit-box-shadow: 0 1px 1px rgba(0,0,0, .2); -moz-box-shadow: 0 1px 1px rgba(0,0,0, .2); box-shadow: 0 1px 1px rgba(0,0,0, .2); text-shadow: 0 1px 0 rgba(255,255,255, 1); }
         #cssmenu ul ul li:hover a,
         #cssmenu li:hover li a {background: #FCF7F7; border: none; color: #000000; -webkit-box-shadow: none; -moz-box-shadow: none;}
         #cssmenu ul ul a:hover {background: #FCF7F7 url(../img/overlay.png) repeat-x 0 -100px !important; color: #000000 !important; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; text-shadow: 0 1px 1px rgba(0,0,0, .1);}
         #cssmenu li:hover > ul {display: block;}
         #cssmenu ul ul {display: none; margin: 0; padding: 0; width: 185px; position: absolute; top: 40px; left: 0; background: #FCF7F7 url(../img/overlay.png) repeat-x 0 0; border: solid 1px #E6E6E6; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; -webkit-box-shadow: 0 1px 3px rgba(0,0,0, .3); -moz-box-shadow: 0 1px 3px rgba(0,0,0, .3); box-shadow: 0 1px 3px rgba(0,0,0, .3);}
         #cssmenu ul ul li {float: none; margin: 0; padding: 3px;  background: #FCF7F7 url(../img/overlay.png) repeat-x 0 0; color: #000000; }
         #cssmenu ul ul a {font-weight: normal; text-shadow: 0 1px 0 #E6E6E6; }
         #cssmenu ul ul ul{display: none; margin: 0; padding: 0; width: 185px; position: absolute; top:0px; left: 185px; background: #FCF7F7 url(../img/overlay.png) repeat-x 0 0; border: solid 1px #E6E6E6; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; -webkit-box-shadow: 0 1px 3px rgba(0,0,0, .3); -moz-box-shadow: 0 1px 3px rgba(0,0,0, .3); box-shadow: 0 1px 3px rgba(0,0,0, .3);}
