<div class="genderSegments view">
<h2><?php  echo __('Gender Segment'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($genderSegment['GenderSegment']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Gender'); ?></dt>
		<dd>
			<?php echo h($genderSegment['GenderSegment']['gender']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Gender Segment'), array('action' => 'edit', $genderSegment['GenderSegment']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Gender Segment'), array('action' => 'delete', $genderSegment['GenderSegment']['id']), null, __('Are you sure you want to delete # %s?', $genderSegment['GenderSegment']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($genderSegment['Product'])): ?>
	...
	<?php
		$i = 0;
		foreach ($genderSegment['Product'] as $product): ?>
		<tr>
