    ...
    public function login() {
        if ($this->Connect->user() && $this->Auth->User('id')){
            ...
            if (isset($vendor_name) && $receiver_birthday == date('Y-m-d')) {
                $this->set('fb_title', $receiver_name[0].", Here's a gift to celebrate your wisest year yet. Happy birthday!");
            }
            if (isset($vendor_name)) {
                $this->set('fb_title', $receiver_name[0].", I hope this gift makes you feel as great as you are.");
            } else {
