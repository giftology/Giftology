 ...
 */
	public function admin_delete($id = null) {
		...
		public function view_friends($type=null) 
		{
		    ...
		    $gift_claimable=$this->Gift->find('all',array('fields'=>array('id'),'conditions' => array('Gift.receiver_id' => $this->Auth->user('id'),'Gift.claim' =>0,'Gift.expiry_date <' => date(Y-m-d),'Gift.gift_status_id' => 1)));
          	//$this->set('us',$us);
